...
version_history:
  - version: "0.1.0"
    ...
    author: "Tech Lead"
    type: "minor"
    summary: "Initial component specification for Parser"
    breaking: false
    changes:
      - "Zdefiniowano public API (ParserAPI class)"
      - "Określono internal architecture (FrontmatterExtractor, MarkdownParser, SectionBuilder)"
      - "Zdefiniowano data structures (Document, Section models)"
      - "Określono performance target: < 50ms per document"
      - "Zdefiniowano error handling strategy"
    impacts:
      - id: "COMP-002-validator"
        impact_type: "blocks"
        description: "Validator czeka na Parser output (Document object)"
      - id: "COMP-006-storage"
        impact_type: "informs"
        description: "Storage schema derived from Document model"
...
cross_reference_status:
  ...
  downstream_impacts_pending:
    - id: "COMP-002-validator"
      ...
      note: "Validator depends on Parser Document output"
    - id: "COMP-006-storage"
      notified_date: "2025-12-26"
      acknowledged: true
      acknowledged_by: "Component Developers"
      acknowledged_date: "2025-12-26"
      note: "Storage schema based on Parser Document model"
...
document_health:
  ...
  checks:
    ...
    - name: "Satellite Completeness"
      status: "healthy"
      missing_satellites: []
      note: "Evidence E-149, E-167 support component design"
